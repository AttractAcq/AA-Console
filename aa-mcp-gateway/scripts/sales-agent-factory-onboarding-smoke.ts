/** Gate 11b uses the existing Harbour bridge, without changing any connector. */
...
try {
  ...
  // Gate 11 (Phase 11 pipeline surface) must still pass unmodified before the
  ...
  console.error(JSON.stringify({ bot_id: config.bot_id, gate: "11b", calls, status: "FAIL",
