...
| Sales agents | Factory RPCs (migration 84); attach/enable/build (migration 89); live Meta deploy remains stub | Implemented for `bot_sales_ops`. `sales_agents.deploy` stays CRITICAL stub. `approved_at` is human-only. |
