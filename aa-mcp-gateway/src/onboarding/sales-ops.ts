 ...
 * Phase 16b (#47): attach_to_page / set_deployment_enabled / build. 22 -> **25**.
 ...
 */
const reads = ["pipeline.list_leads", "pipeline.get_lead", "pipeline.get_stalled_leads", "pipeline.get_pipeline_summary", "sales_agents.list", "sales_agents.get", "sales_agents.get_conversations", "brand.get_profile", "workflow.get_pending_approvals", "workflow.get_activity", "workflow.list_tasks", "workflow.get_task"] as const;
const writes = ["pipeline.update_stage", "pipeline.create_followup", "sales_agents.generate_config", "sales_agents.create", "sales_agents.update_knowledge", "sales_agents.update_qualification_rules", "sales_agents.test", "sales_agents.attach_to_page", "sales_agents.set_deployment_enabled", "sales_agents.build", "workflow.create_task", "workflow.assign_task", "workflow.complete_task", "workflow.create_approval", "sites.provision", "sites.publish_page"] as const;
